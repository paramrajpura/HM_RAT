...
def main():
    tetrodes_list = [2,4,7,9,11,12,13,14,17,18,22,23,24,25,26,28,29,30,31]
    ...
    directory = "/mnt/genzel/Rat/HM/Rat_HM_Ephys/Preprocess/Rat1_20200909"
    ...
    for tt_num in tetrodes_list:
        this_name = 'Rat_Hm_Ephys_Rat1_389236_20200909_nt' + str(tt_num) + '_Preprocess.mda'   

        output = os.path.join('/media/genzel/data/spikesorting/Rat/Rat1_20200909', 'output_T' + str(tt_num))
        ...
        if run_phy:
            ...
            this_data_folder = "/media/genzel/data/spikesorting/Rat/Rat1_20200909"
            this_tt = '31'
            this_params_file = os.path.join(this_data_folder, 'output_T' + this_tt, 'phy_AGR' 'params.py')
